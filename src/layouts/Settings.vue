...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const currencies = Object.freeze([
      ...
      { label: 'Orb of Fusing', value: 'fusing' },
      { label: 'Orb of Alchemy', value: 'alch' },
      { label: 'Chaos Orb', value: 'chaos' },
      { label: "Gemcutter's Prism", value: 'gcp' },
      { label: 'Exalted Orb', value: 'exalted' },
      { label: 'Chromatic Orb', value: 'chrome' },
      { label: "Jeweller's Orb", value: 'jewellers' },
      { label: "Engineer's Orb", value: 'engineers' },
      ...
      { label: 'Orb of Annulment', value: 'annul' },
      ...
      { label: 'Scroll of Wisdom', value: 'wisdom' },
      { label: 'Portal Scroll', value: 'portal' },
      { label: "Armourer's Scrap", value: 'scrap' },
      { label: "Blacksmith's Whetstone", value: 'whetstone' },
      { label: "Glassblower's Bauble", value: 'bauble' },
      { label: 'Orb of Transmutation', value: 'transmute' },
      { label: 'Orb of Augmentation', value: 'aug' },
      { label: 'Mirror of Kalandra', value: 'mirror' },
